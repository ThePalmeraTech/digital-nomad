 ...
 *
 * Muestra el enlace para descargar el archivo subido mediante File Manager
 * Ruta obtenida de la opción palmerita_file_zip_url. Si no existe muestra error.
 *
...
// Obtener URL del archivo desde la opción (si falla, fallback a plugin assets, pero se mostrará advertencia)
